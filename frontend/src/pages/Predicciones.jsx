...
const partidosGrupos = [
  ...
  // GRUPO B
  { id: 7,  equipo_local: 'Canadá',           equipo_visitante: 'Bosnia y Herzegovina', grupo: 'Grupo B', fecha_hora: '2026-06-12T14:00:00', fase: 'grupos' },
  { id: 8,  equipo_local: 'Qatar',            equipo_visitante: 'Suiza',              grupo: 'Grupo B', fecha_hora: '2026-06-13T14:00:00', fase: 'grupos' },
  { id: 9,  equipo_local: 'Suiza',            equipo_visitante: 'Bosnia y Herzegovina', grupo: 'Grupo B', fecha_hora: '2026-06-18T14:00:00', fase: 'grupos' },
  ...
  { id: 12, equipo_local: 'Bosnia y Herzegovina', equipo_visitante: 'Qatar',          grupo: 'Grupo B', fecha_hora: '2026-06-24T14:00:01', fase: 'grupos' },
  // GRUPO C
...
export default function Predicciones() {
  ...
  const onChange = (localId, team, value) => {
    ...
    setGuardados(prev => ({ ...prev, [localId]: false }));
  };
